...
export default function CheckoutPage() {
  ...
  const [products, setProducts] = useState<FetchWatch[]>([]);
  useEffect(() => {
    const cart = JSON.parse(localStorage.getItem("cart") || "{}");
    const cartItems = Object.values(cart) as FetchWatch[];
  ...
  return (
    <>
  {/* Hero Section */}
  <h2 className="text-3xl font-bold text-center my-28">
        Check<span className="text-blue-600 dark:text-blue-400">out Page</span>
      </h2>

  {/* Checkout Form */}
  <form
    onSubmit={handleSubmit}
    className="container mx-auto px-4 pb-3 md:px-6 lg:px-8 flex flex-col lg:flex-row gap-8"
  >
    ...
    <div className="w-full lg:w-1/2 p-6 rounded-lg border-2 border-gray-200 bg-gray-50">
      ...
      {/* Order Items */}
      <div className="space-y-4">
        {products.map((product: FetchWatch) => (
