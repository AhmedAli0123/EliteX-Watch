...
const MensWatches = () => {
  ...
  useEffect(() => {
    const fetchWatches = async () => {
      const query = `*[_type == "watch" && category == "mens"]{_id, name, "slug": slug.current, price, originalPrice, "image": image.asset->url}`;
  ...
  return (
    <section className="py-10 bg-gray-50 dark:bg-gray-900 min-h-screen my-14">
      <h2 className="text-3xl font-bold text-center mb-6">
        Men&apos;s <span className="text-blue-600 dark:text-blue-400">Watches</span>
      </h2>
